const AboutData = {
  ...
  description: [
    ...
    "📊 Data Visualization: Numbers tell stories, and I bring them to life with Tableau and Python libraries for compelling insights.",
    "🚀 I believe in continuous learning, effective time management, and strong teamwork to drive innovation and success. Let's build the future together!"
  ],
};
